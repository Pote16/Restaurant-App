...
const DB_HOST = environment.DB_HOST || "localhost";
const DB_USER = environment.DB_USER;
const DB_PASSWORD = environment.DB_PASSWORD;
const DB_NAME = environment.DB_NAME;
const DB_PORT = environment.DB_PORT || 3306;


const PORT = environment.PORT || 3000;
const DOMAIN = environment.DOMAIN || `localhost:${PORT}`;
